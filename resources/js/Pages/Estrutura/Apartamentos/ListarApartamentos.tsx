...
export default function ListarApartamentos({auth}:PageProps){
        ...
        >
            ...
            <ol className="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <div className="flex items-center">
                    ...
                    <span className="ml-1 text-sm font-medium text-gray-500 md:ml-2 dark:text-gray-400">Listar Apartamentos</span>
                </div>
                </li>
            </ol>
            </nav>
            ...
            <div className="max-w-7xl mx-auto sm:px-6 mt-5 lg:px-8 space-y-6">
                <div className="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
                    <p className="text-2xl font-bold">Lista de Apartamentos</p>
                </div>
            </div>
            </AuthenticatedLayout>
    )
